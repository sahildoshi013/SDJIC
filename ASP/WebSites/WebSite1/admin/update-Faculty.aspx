<%@ Page Title="" Language="VB" MasterPageFile="~/admin/MasterPage.master" AutoEventWireup="false" CodeFile="update-Faculty.aspx.vb" Inherits="Default2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="head-line">
    <asp:Label ID="Label8" runat="server" Text="Update Faculty Data" ForeColor="White" 
