<%@ Page Title="" Language="VB" MasterPageFile="~/admin/MasterPage.master" AutoEventWireup="false" CodeFile="add-students.aspx.vb" Inherits="Default2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="head-line">
            <asp:Label ID="Label8" runat="server" Text="Add Student Data" ForeColor="White" 
