...
if(isset($_POST['submit']))
{
	...
	{
		$ins_query="insert into faculty_login(f_name,f_address,f_b_day,f_b_month,f_b_year,f_stream,f_mail,f_cono,f_ex,f_degree,username,password) values ('$name','$address',$b_day,$b_month,$b_year,'$stream','$mail','$cono',$ex,'$degree','$username','$password')";
